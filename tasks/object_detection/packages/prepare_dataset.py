...
from dataset_activity import convert_labelme_json, IMAGE_SIZE, CLASSES
...
OUT_DIR = os.path.join(PROJECT_ROOT, "tasks", "object_detection", "dataset")
...
def main():
    ...
    print(os.path.join(OUT_DIR, "train"))
    print(os.path.join(OUT_DIR, "val"))
